      ...
      <div className='overview-container'>
        ...
        <div className="info-content">
          ...
          <div className="genetic-testing-container">
            ...
            <p className='light-text genetic-testing-text' >Because many of these criteria are not apparent in the first year of life and infants with Dravet syndrome initially experience typical development,<span className='bold-text'> genetic testing via an epilepsy panel should be considered in patients exhibiting any of the following:</span> </p>
            <ul className='light-text lists'>
            ...
            <p className='light-text genetic-testing-text'>If you suspect your loved one might have Dravet syndrome, ask your neurologist about testing, which is available through your doctor or commercially. An epilepsy panel will test for SCN1A as well as many other genes commonly associated with epilepsy. Following testing, consultation with a genetic counselor is recommended. Genetic testing is recommended in patients of ALL ages, including in adults with a suspected diagnosis but for whom a detailed history of presentation in infancy may be limited. While simple SCN1A sequencing is appropriate when all clinical criteria are met, an epilepsy gene panel is the expert preference for children with suspected DS.  Invitae’s Behind the Seizure Program provides no-charge genetic testing (epilepsy panel) for patients in the US under the age of 8 years that have experienced at least one unprovoked seizure. Another company, Probably Genetic offers no-cost genetic testing (whole exome sequencing) for pediatric-onset epilepsy.</p>
            <p className='light-text genetic-testing-text'>Dravet syndrome presents differently in each patient. Individuals with Dravet syndrome are often misdiagnosed with another seizure disorder such as Lennox Gastaut or Myoclonic Astatic Epilepsy, or given a broad diagnosis of intractable epilepsy. Some epilepsy syndromes, like PCDH19, a rare x-linked epilepsy found more often in females than males, share many characteristics with Dravet syndrome. There are subtle differences between these epilepsy syndromes and Dravet, and you should consult with your child’s neurologist if you have any questions about related epilepsies.</p>
          </div>
          <div className="refernces">
            <p className='light-text'>References</p>
            <ol  className='light-text'>
              <li>Wu, E., et. al. (2015). Incidence of Dravet Syndrome in a US Population. Pediatrics 136(5): 1310-e1315. doi: 10.1542/peds.2015-1807. https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4621800/</li>
